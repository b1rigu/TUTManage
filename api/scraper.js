...
export const getClassesStepOne = async () => {
...
export const getClassesStepTwo = async (username, password, browserEndpoint) => {
...
export const getClassesStepThree = async (oneTimePass, browserEndpoint) => {
    const browser = await puppeteer.connect({
        browserWSEndpoint: browserEndpoint,
        args: chromium.args,
        defaultViewport: chromium.defaultViewport,
...
export const getClassesStepFour = async (browserEndpoint) => {
    const browser = await puppeteer.connect({
        browserWSEndpoint: browserEndpoint,
        args: chromium.args,
        defaultViewport: chromium.defaultViewport,
...
export const getClassesStepFive = async (browserEndpoint) => {
    const browser = await puppeteer.connect({
        browserWSEndpoint: browserEndpoint,
        args: chromium.args,
        defaultViewport: chromium.defaultViewport,
